...
jwork.fileUpload.prototype.appendFileRow = function(file, isSaved) {
	...
	var btnUrl  = file.isSaved ? this.getBtnUrl(file) : "";
...
jwork.fileUpload.prototype.getBtnUrl = function(file) {
	...
	return jQuery("<span>복사</span>").bind("click", 
			function() {
				var $temp = $("<input>");
				$("body").append($temp);
				$temp.val(ctx+"/jfile/readDownloadFile.do?fileId="+fileId+"&fileSeq="+fileSeq).select();
