...
<body>
  <div id="pop">
    ...
    <div id="pop_cont">  
    <form id="frm" name="frm" method="post" action="/cms/codeUtil/bplcPop3/">
        ...
        <table summary="사업장을 검색조건으로 선택하여 조회할 수 있습니다. 사업장유형, 사업장명, 사업자 등록번호순으로 보여줍니다.">
          ...
          <tbody>
            ...
            <tr>
              <th>사업장 유형</th>
              <td colspan="3">
              <html:selectList name='pBlcSeCode' optionNames="폐수배출업체" optionValues="0106" selectedValue='${param.pBlcSeCode}'  title="사업장유형" script="class='W200' readonly='readonly'" />
              </td>
            </tr>
            <tr>
              <th>사업자명</th>
        ...
        <tbody>
          <c:forEach items="${bplcList}" var="EO" varStatus="stat">
            <tr>
              ...
              <td><a href="#" onclick="setBplcCode('<c:out value='${EO.BPLC_NO}'/>','<c:out value='${EO.BIZRNO}'/>','<c:out value='${EO.BPLC_SE_CODE}'/>','<c:out value='${EO.BPLC_NM}'/>');"><c:out value='${EO.RPRSNTV_NM}' /></a></td>
