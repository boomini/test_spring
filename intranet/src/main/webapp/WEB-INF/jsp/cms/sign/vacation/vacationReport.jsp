...
<body>
	...
	<div class="W100p subpage MgT10">
	   <!-- 프린트 영역 start -->
			<h2 class="W100p MgT50 AC VM H50" style="font-size:30px;">휴가 신청서</h2>
			...
			<table class="pr_content">
				...
				<tbody>
					<tr>
						<th colspan="4" style="background:#f7f7f7;">신 청 내 역</th>
					</tr>
					<tr>
						<th>부 서</th>
					...
					<tr>
						<th>연락처</th>
						<td><c:out value="${sign.PNUM}"/></td>
						<th>성 명</th>
						<td><c:out value="${sign.USER_NM}"/></td>
					</tr>
					<tr>
						<th>휴가구분</th>
						<td colspan="3"><c:out value="${sign.VACNM}"/></td>
					</tr>
					<tr>
						<th>일 시</th>
						<td colspan="3">
						<c:out value="${sign.STARTDAY}"/>
						~
						<c:out value="${sign.ENDDAY}"/>
						</td>
					</tr>
					<tr>
						<th>사 유</th>
						<td colspan="3"><c:out value="${sign.REASON}"/></td>
					</tr>
				</tbody>
			</table>
			<div class="AC" style="font-size: 20px;">
				<p class="MgT100">위와 같이 휴가를 신청하오니 허가하여 주시기 바랍니다.</p>
