			...
			<div class="content">
				...
				<div class="content_right">
					...
					<table id="fileAreaTable" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" class="board_view2">
						<col width="*"/><col width="12%"/><col width="30%"/><col width="10%"/><col width="10%"/><col width="10%"/>
						<tr>
							...
							<th class="top" style="background-image: url('${ctx}/jfile/resources/swfupload/images/text-bg.gif');background-repeat: repeat-x;">삭제</th>
							<th class="topend" style="background-image: url('${ctx}/jfile/resources/swfupload/images/text-bg.gif');background-repeat: repeat-x;">url</th>
						</tr>
						<tr id="noDataRow">
							<td class="all_txt" colspan="6" style="text-align: center;">첨부된 파일이 없습니다.</td>
						</tr>
					</table>
					</div>
				</div>
