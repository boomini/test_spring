...
public class JFileVO implements JFileDetails {
	...
	private int fileThumbnailWidth = 320;
	private int fileThumbnailHeigth = 200;
	...
	public int getFileThumbnailWidth() {
		return fileThumbnailWidth;
	}
	public void setFileThumbnailWidth(int fileThumbnailWidth) {
		this.fileThumbnailWidth = fileThumbnailWidth;
	}
	public int getFileThumbnailHeigth() {
		return fileThumbnailHeigth;
	}
	public void setFileThumbnailHeigth(int fileThumbnailHeigth) {
		this.fileThumbnailHeigth = fileThumbnailHeigth;
	}
	...
	public String toString() {
		return "JFileVO [fileId=" + fileId + ", fileSeq=" + fileSeq + ", fileName=" + fileName + ", fileSize=" + fileSize + ", fileMask=" + fileMask + ", fileThumbnailMask=" + fileThumbnailMask + ", fileThumbnailYn=" + fileThumbnailYn + ", downloadCount=" + downloadCount + ", downloadExpireDate=" + downloadExpireDate + ", downloadLimitCount=" + downloadLimitCount + ", regDate=" + regDate + ", useSecurity=" + useSecurity + ", uploadMode=" + uploadMode + ", fileType=" + fileType + ", fileThumbnailWidth=" + fileThumbnailWidth + ", fileThumbnailHeigth=" + fileThumbnailHeigth + "]";
	}
